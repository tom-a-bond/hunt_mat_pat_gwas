...
# subset bgen files with genome wide snps, write bgen files for sample 1 gwas
...
for j in {1..6}; do
  ...
  -incl-samples ${keep_path}dmo_ids_mothers_${j}.txt \
  -bgen-omit-sample-identifier-block \
  -og ${outpath}hunt_sample1_mothers_${j}_chr${PBS_ARRAY_INDEX}.bgen \
  -os ${outpath}hunt_sample1_mothers_${j}_chr${PBS_ARRAY_INDEX}.sample
done
...
for j in {1..6}; do
  ...
  ${keep_path} \
  ${outpath} \
  hunt_sample1_mothers_${j}_chr${PBS_ARRAY_INDEX} \
  dmo_id_suffixes_mothers_${j}.txt
done
...
# mothers
${qctool} \
-g ${outpath}hunt_sample1_mothers_1_chr${PBS_ARRAY_INDEX}.bgen \
-s ${outpath}hunt_sample1_mothers_1_chr${PBS_ARRAY_INDEX}_suffixes.sample \
-g ${outpath}hunt_sample1_mothers_2_chr${PBS_ARRAY_INDEX}.bgen \
-s ${outpath}hunt_sample1_mothers_2_chr${PBS_ARRAY_INDEX}_suffixes.sample \
-g ${outpath}hunt_sample1_mothers_3_chr${PBS_ARRAY_INDEX}.bgen \
-s ${outpath}hunt_sample1_mothers_3_chr${PBS_ARRAY_INDEX}_suffixes.sample \
-g ${outpath}hunt_sample1_mothers_4_chr${PBS_ARRAY_INDEX}.bgen \
-s ${outpath}hunt_sample1_mothers_4_chr${PBS_ARRAY_INDEX}_suffixes.sample \
-g ${outpath}hunt_sample1_mothers_5_chr${PBS_ARRAY_INDEX}.bgen \
-s ${outpath}hunt_sample1_mothers_5_chr${PBS_ARRAY_INDEX}_suffixes.sample \
-g ${outpath}hunt_sample1_mothers_6_chr${PBS_ARRAY_INDEX}.bgen \
-s ${outpath}hunt_sample1_mothers_6_chr${PBS_ARRAY_INDEX}_suffixes.sample \
-og ${outpath}hunt_sample1_mothers_chr${PBS_ARRAY_INDEX}.bgen \
-os ${outpath}hunt_sample1_mothers_chr${PBS_ARRAY_INDEX}.sample
