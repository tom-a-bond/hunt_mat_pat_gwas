...
#for((i = 0; i < ${#outcomes[@]}; i++)); do
  ...
  # set name for continuous covariate file, dependent on whether we need to adjust this phenotype for fasting time
  ...
  ${gcta} \
		...
		--mbgen ${imp_path}${cohort_name}_sample1_mothers_bgen_list.txt \
